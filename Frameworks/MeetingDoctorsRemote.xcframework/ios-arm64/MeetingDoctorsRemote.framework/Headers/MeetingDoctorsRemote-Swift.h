...
SWIFT_CLASS("_TtC20MeetingDoctorsRemote18MDASessionDelegate")
...
@interface MDASessionDelegate (SWIFT_EXTENSION(MeetingDoctorsRemote)) <NSURLSessionDownloadDelegate>
...
@interface MDASessionDelegate (SWIFT_EXTENSION(MeetingDoctorsRemote)) <NSURLSessionDelegate>
...
@interface MDASessionDelegate (SWIFT_EXTENSION(MeetingDoctorsRemote)) <NSURLSessionStreamDelegate>
...
@interface MDASessionDelegate (SWIFT_EXTENSION(MeetingDoctorsRemote)) <NSURLSessionDataDelegate>
...
@interface MDASessionDelegate (SWIFT_EXTENSION(MeetingDoctorsRemote)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC20MeetingDoctorsRemote15MDATaskDelegate")
...
SWIFT_CLASS("_TtC20MeetingDoctorsRemote31NotSecuredNetworkSessionManager")
